...
if __name__ == '__main__':
    iface = gr.Interface(
        ...
        inputs=[
            ...
            gr.Dropdown(choices=['TCN', 'LSTM', 'MLP', 'RandomForest', 'KNeighbors', 'DecisionTree', 'LogisticRegression', 'SVM'], value='TCN', label='Classifier', info='Select the classifier type.'),
        ...
        outputs=gr.Textbox(),
        title="Prognostika - Hard Disk Failure Prediction",  # Title of the interface
        description="Predicting Hard Disk Failures in Data Centers using Temporal Convolutional Neural Networks",  # Description of the interface
    )
