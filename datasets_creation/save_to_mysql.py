...
def save_to_mysql(db_user, db_password, db_host, db_port, db_name, model, years, failed, base_path, output_dir):
    ...
    return "Data saved to MySQL database in table 'hdd_data'."
